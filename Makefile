PRODUCT_NAME       = FinalProject_FirstLast
SOURCES            = myLib.c main.c player.c playerSprites.c enemySprites.c titleSong.c gameM1.c gameM2.c swordSound1.c swordSound2.c swordSound3.c enemySwordHit.c swordMiss.c swordBlock.c hud.c heal.c effects.c gameStructs.c startBackground.c mainBackground.c winBackground.c loseBackground.c pauseBackground.c instructionsBackground.c instructionsBackCanvas.c gameBackground.c collisionmap.c Ending.c winText.c
